    ...
    <div v-if="groupedItems.length">
      <div v-for="(group, index) in groupedItems" :key="index" class="mb-5">
        <div class="bg-light border rounded p-3 mb-2">
          ...
          <div v-for="item in group.items" :key="item.cartItemId" class="d-flex border-bottom py-3 gap-3">
            <img :src="item.productVariant.product.productImage" alt="product" class="rounded"
